...
export const AuthButtons = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 justify-center md:justify-start">
      {isAuthenticated && <LogoutLink className="px-4 py-2 border border-red-200 text-red-600 rounded-md hover:bg-red-50 transition cursor-pointer">
          Log Out
        </LogoutLink>}
      { !isAuthenticated && (<><LoginLink className="px-4 py-2 font-medium text-gray-700 hover:text-blue-600 cursor-pointer">
        Sign In
      </LoginLink>
